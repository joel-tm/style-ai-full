...
async def suggest_outfit_from_wardrobe(
    ...
    prompt = (
        ...
        f"RULES:\n"
        f"1. There are TWO valid outfit options — choose ONE:\n"
        f"   Option A: Select exactly 1 'Tops' item + 1 'Bottoms' item + 1 'Footwear' item.\n"
        f"   Option B: Select exactly 1 'Dresses' item + 1 'Footwear' item (no top or bottom needed).\n"
        f"2. Use Option B only if a suitable dress exists in the wardrobe for the occasion and weather.\n"
